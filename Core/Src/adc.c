...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, C_MPPT_1_Pin|C_MPPT_2_Pin|C_MPPT_3_Pin|C_MPPT_4_Pin
                          |T_MOTOR_Pin|T_ESC_Pin);

    HAL_GPIO_DeInit(GPIOA, C_MPPT_5_Pin|C_MPPT_6_Pin|HYDROFOIL_Pin|T_MPPT_2_Pin
                          |T_MPPT_3_Pin|T_MPPT_4_Pin|T_MPPT_5_Pin|T_MPPT_6_Pin);

    HAL_GPIO_DeInit(GPIOB, MULTIPLEXER_Pin|THROTTLE_Pin);
